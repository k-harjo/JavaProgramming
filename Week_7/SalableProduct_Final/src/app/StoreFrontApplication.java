...
/**
 * Main application class that serves as the starting point to run the Store Front Application.
 * This class provides a text-based user interface to interact with the Store Front, make purchases, and manage inventory.
 */
public class StoreFrontApplication {
    public static void main(String[] args) {
        ...
        // Display checkout message, list of purchased items, and total price to the user.
